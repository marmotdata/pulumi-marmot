...
namespace Pulumi.Marmot
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Marmot.version.txt");
    ...
    internal sealed class MarmotResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public MarmotResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
