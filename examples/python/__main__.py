import pulumi
import pulumi_marmot as marmot

config = pulumi.Config()
marmot_host = config.require("marmot:host")
marmot_api_key = config.require("marmot:apiKey")
kafka_asset = marmot.Asset("kafkaAsset",
...
postgres_asset = marmot.Asset("postgresAsset",
...
service_asset = marmot.Asset("serviceAsset",
...
kafka_to_service_lineage = marmot.Lineage("kafkaToServiceLineage",
    source=kafka_asset.mrn,
    target=service_asset.mrn,
    opts = pulumi.ResourceOptions(depends_on=[
            kafka_asset,
            service_asset,
        ],
        ignore_changes=[resource_id]))
service_to_postgres_lineage = marmot.Lineage("serviceToPostgresLineage",
    source=service_asset.mrn,
    target=postgres_asset.mrn,
    opts = pulumi.ResourceOptions(depends_on=[
            service_asset,
            postgres_asset,
        ],
        ignore_changes=[resource_id]))
service_to_s3_lineage = marmot.Lineage("serviceToS3Lineage",
    source=service_asset.mrn,
    target=s3_asset.mrn,
    opts = pulumi.ResourceOptions(depends_on=[
            service_asset,
        ...
        ignore_changes=[resource_id]))
pulumi.export("kafkaAssetId", {
    "value": kafka_asset.resource_id,
})
pulumi.export("kafkaAssetMrn", {
    "value": kafka_asset.mrn,
})
pulumi.export("postgresAssetId", {
    "value": postgres_asset.resource_id,
})
pulumi.export("postgresAssetMrn", {
    "value": postgres_asset.mrn,
})
pulumi.export("S3AssetId", {
    "value": s3_asset.resource_id,
})
pulumi.export("S3AssetMrn", {
    "value": s3_asset.mrn,
})
pulumi.export("serviceAssetId", {
    "value": service_asset.resource_id,
})
pulumi.export("serviceAssetMrn", {
    "value": service_asset.mrn,
})
pulumi.export("kafkaToServiceLineageId", {
    "value": kafka_to_service_lineage.resource_id,
})
pulumi.export("serviceToPostgresLineageId", {
    "value": service_to_postgres_lineage.resource_id,
})
